...
Whilst neo gratefully welcomes contributions from the open-source
...
neo is written in Sass, which provides us with a lot of incredibly powerful
features. However, we do not want neo to become a platform for Sass’
capabilities—all code that comes into neo should be as simple and CSS-like
as possible.

Adding this complexity is against a number of neo’ core principles of
...
* **It creates a barrier to entry.** neo is working very hard to become a
...
Example:
[`f000350`](https://github.com/neo/neo/commit/f000350dd23b92cb403142f4a8af84d92d300cf7).
Here I can see that the ‘Implement proposed flag object fix’ commit happened
against [issue 76](https://github.com/neo/neo/issues/76), and took
